"""
LQR-specific tuner panel.

Provides sliders for Q and R weight matrices.
"""
...
class LQRTunerPanel(BaseTunerPanel):
    """
    LQR-specific tuner panel with Q and R weight sliders.
    """
    ...
    def create_controls(self):
        """Create LQR-specific controls (Q and R weight sliders)."""
